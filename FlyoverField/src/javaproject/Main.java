...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaproject/hand-right.png"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaproject/download.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
           ...
           String query = "select * from ADD_GN"; 
           ResultSet r1 = st.executeQuery(query);
           while(r1.next())
           {
               String name = r1.getString("NAME");
           String mobile_no = r1.getString("MOBILE_NO");
           String place = r1.getString("PLACE");
           String availability = r1.getString("AVAILABILITY");
           
           Confirm ob1 = new Confirm();
           ob1.jLabel3.setText(name);
           ob1.jLabel4.setText(mobile_no);
           ob1.jLabel5.setText(place);
           ob1.jLabel6.setText(availability);

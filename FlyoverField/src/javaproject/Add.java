...
public class Add extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the Deals");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String query = "insert into ADD_GN values('"+name+"','"+mobile_no+"','"+place+"','"+availability+"')";
        ...
        ob1.jLabel1.setText(name);
        ob1.jLabel3.setText(mobile_no);
        ob1.jLabel4.setText(place);
        ob1.jLabel5.setText(availability);

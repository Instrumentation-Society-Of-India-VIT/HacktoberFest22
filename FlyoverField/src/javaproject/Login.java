...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String ph_num = jTextField2.getText();
        ...
        try{
            ...
            String query = "select NAME,PHONE_NO,PASSWORD from REGISTER";
            ResultSet r1 = st.executeQuery(query);
            while(r1.next())
            {
                String name1 = r1.getString("NAME");
                String ph_no = r1.getString("PHONE_NO");
                String passw = r1.getString("PASSWORD");
             
                if(name.equals(name1)&&pass.equals(passw)&&ph_no.equals(ph_num))
                {
